...
from app.models.claim import ClaimState, DocumentType, ExtractedDocument
from app.models.evidence import EvidenceLink
from app.policy.exclusions import diagnosis_excluded_reason
from app.policy.loader import PolicyTerms, get_policy
from app.policy.waiting_periods import _matched_condition
...
def _op_category_covered(val: bool, ctx: _Ctx, _: int) -> bool:
    from app.policy.coverage import is_category_covered
