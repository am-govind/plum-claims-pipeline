...
def _new_cost() -> "CostBreakdown":
    from app.models.cost import CostBreakdown
...
from app.models.cost import CostBreakdown
from app.models.decision import Decision, LineItemDecision, PolicyFinding
from app.models.evidence import Contradiction
