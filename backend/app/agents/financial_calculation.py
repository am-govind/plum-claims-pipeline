...
Pure deterministic math (no LLM). Delegates to ``app.policy.coverage`` so the
order of operations lives in one place and is easy to test against TC010's
expected math: 4500 -> -20% network -> 3600 -> -10% co-pay -> 3240.
...
from app.models.decision import PolicyFinding, RejectionReason
from app.models.trace import TraceStatus
from app.policy.coverage import apply_financial_calculation
