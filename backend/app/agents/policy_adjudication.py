...
``app.policy.rules``. This makes audit easy: every rejection traces back
to a named rule with the resolved policy values it saw.
...
from app.policy.rules import RuleResult, get_rule_engine
